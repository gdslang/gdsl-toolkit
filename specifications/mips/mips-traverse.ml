...
val traverse f insn = 
   case insn of
      ABS-fmt x: f "ABS" (BINOP_FMT x)
    | ADD x: f "ADD" (TERNOP x)
    | ADD-fmt x: f "ADD" (TERNOP_FMT x)
    ...
    | CVT-D-fmt x: f "CVT.D" (BINOP_FMT x)
    | CVT-L-fmt x: f "CVT.L" (BINOP_FMT x)
    | CVT-PS-S x: f "CVT.PS.S" (TERNOP x)
    | CVT-S-fmt x: f "CVT.S" (BINOP_FMT x)
    | CVT-S-PL x: f "CVT.S.PL" (BINOP x)
    | CVT-S-PU x: f "CVT.S.PU" (BINOP x)
    | CVT-W-fmt x: f "CVT.W" (BINOP_FMT x)
    | DERET: f "DERET" (NULLOP)
    | DI x: f "DI" (UNOP x)
    | DIV x: f "DIV" (BINOP_SRC x)
    | DIV-fmt x: f "DIV" (TERNOP_FMT x)
    | DIVU x: f "DIVU" (BINOP_SRC x)
    | EI x: f "EI" (UNOP x)
    | ERET: f "ERET" (NULLOP)
    | EXT x: f "EXT" (QUADOP x)
    | FLOOR-L-fmt x: f "FLOOR.L" (BINOP_FMT x)
    | FLOOR-W-fmt x: f "FLOOR.W" (BINOP_FMT x)
    | INS x: f "INS" (QUADOP x)
    | J x: f "J" (UNOP_SRC x)
    | JAL x: f "JAL" (UNOP_SRC x)
    | JALR x: f "JALR" (BINOP x)
    | JALR-HB x: f "JALR.HB" (BINOP x)
    | JALX x: f "JALX" (UNOP_SRC x)
    | JR x: f "JR" (UNOP_SRC x)
    | JR-HB x: f "JR.HB" (UNOP_SRC x)
    | LB x: f "LB" (TERNOP x)
    ...
    | MADD-fmt x: f "MADD" (QUADOP_FMT x)
    ...
    | MOV-fmt x: f "MOV" (BINOP_FMT x)
    | MOVF x: f "MOVF" (TERNOP x)
    | MOVF-fmt x: f "MOVF" (TERNOP_FMT x)
    | MOVN x: f "MOVN" (TERNOP x)
    | MOVN-fmt x: f "MOVN" (TERNOP_FMT x)
    | MOVT x: f "MOVT" (TERNOP x)
    | MOVT-fmt x: f "MOVT" (TERNOP_FMT x)
    | MOVZ x: f "MOVZ" (TERNOP x)
    | MOVZ-fmt x: f "MOVZ" (TERNOP_FMT x)
    | MSUB x: f "MSUB" (BINOP_SRC x)
    | MSUB-fmt x: f "MSUB" (QUADOP_FMT x)
    ...
    | MUL-fmt x: f "MUL" (TERNOP_FMT x)
    | MULT x: f "MULT" (BINOP_SRC x)
    | MULTU x: f "MULTU" (BINOP_SRC x)
    | NEG-fmt x: f "NEG" (BINOP_FMT x)
    | NMADD-fmt x: f "NMADD" (QUADOP_FMT x)
    | NMSUB-fmt x: f "NMSUB" (QUADOP_FMT x)
    ...
    | RECIP-fmt x: f "RECIP" (BINOP_FMT x)
    | ROTR x: f "ROTR" (TERNOP x)
    | ROTRV x: f "ROTRV" (TERNOP x)
    | ROUND-L-fmt x: f "ROUND.L" (BINOP_FMT x)
    | ROUND-W-fmt x: f "ROUND.W" (BINOP_FMT x)
    | RSQRT-fmt x: f "RSQRT" (BINOP_FMT x)
    ...
    | TRUNC-L-fmt x: f "TRUNC.L" (BINOP_FMT x)
    | TRUNC-W-fmt x: f "TRUNC.W" (BINOP_FMT x)
