...
val traverse f insn = 
   case insn of
    ...
    | LB x: f "LB" (TERNOP_LRR x)
    | LBE x: f "LBE" (TERNOP_LRR x)
    | LBU x: f "LBU" (TERNOP_LRR x)
    | LBUE x: f "LBUE" (TERNOP_LRR x)
    | LDC1 x: f "LDC1" (TERNOP_LRR x)
    | LDC2 x: f "LDC2" (TERNOP_RRR x)
    | LDXC1 x: f "LDXC1" (TERNOP_LRR x)
    | LH x: f "LH" (TERNOP_LRR x)
    | LHE x: f "LHE" (TERNOP_LRR x)
    | LHU x: f "LHU" (TERNOP_LRR x)
    | LHUE x: f "LHUE" (TERNOP_LRR x)
    | LL x: f "LL" (TERNOP_LRR x)
    | LLE x: f "LLE" (TERNOP_LRR x)
    | LUI x: f "LUI" (BINOP_LR x)
    | LUXC1 x: f "LUXC1" (TERNOP_LRR x)
    | LW x: f "LW" (TERNOP_LRR x)
    | LWC1 x: f "LWC1" (TERNOP_LRR x)
    | LWC2 x: f "LWC2" (TERNOP_RRR x)
    | LWE x: f "LWE" (TERNOP_LRR x)
    | LWL x: f "LWL" (TERNOP_LRR x)
    | LWLE x: f "LWLE" (TERNOP_LRR x)
    | LWR x: f "LWR" (TERNOP_LRR x)
    | LWRE x: f "LWRE" (TERNOP_LRR x)
    | LWXC1 x: f "LWXC1" (TERNOP_LRR x)
    ...
    | SB x: f "SB" (TERNOP_RRR x)
    | SBE x: f "SBE" (TERNOP_RRR x)
    | SC x: f "SC" (TERNOP_LRR x)
    | SCE x: f "SCE" (TERNOP_LRR x)
    | SDBBP x: f "SDBBP" (UNOP_R x)
    | SDC1 x: f "SDC1" (TERNOP_RRR x)
    | SDC2 x: f "SDC2" (TERNOP_RRR x)
    | SDXC1 x: f "SDXC1" (TERNOP_RRR x)
    | SEB x: f "SEB" (BINOP_LR x)
    | SEH x: f "SEH" (BINOP_LR x)
    | SH x: f "SH" (TERNOP_RRR x)
    | SHE x: f "SHE" (TERNOP_RRR x)
    ...
    | SUXC1 x: f "SUXC1" (TERNOP_RRR x)
    | SW x: f "SW" (TERNOP_RRR x)
    | SWC1 x: f "SWC1" (TERNOP_RRR x)
    | SWC2 x: f "SWC2" (TERNOP_RRR x)
    | SWE x: f "SWE" (TERNOP_RRR x)
    | SWL x: f "SWL" (TERNOP_RRR x)
    | SWLE x: f "SWLE" (TERNOP_RRR x)
    | SWR x: f "SWR" (TERNOP_RRR x)
    | SWRE x: f "SWRE" (TERNOP_RRR x)
    | SWXC1 x: f "SWXC1" (TERNOP_RRR x)
