...
val /immrotate ['rotate:2 00 0111'] = do
  imm <- return (immediate (IMM2 rotate));
  update@{shift={amount=(imm^'000'), shifttype=ROR}}
end
...
val / ['/cond 011 1 0 0 0 0 /rd /ra /rm 0011 /rn'] = ml SMLAD cond set0 rd ra rn
...
### QDSUB
###  - Saturating Double and Substract
...
# --- Advanced SIMD parallel addition and substraction instructions ----
