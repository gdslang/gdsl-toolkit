...
val rreil-convert-sem-address cbs closure address = cbs.sem_address.sem_address closure address.size (rreil-convert-sem-linear cbs closure address.address)

val rreil-convert-sem-var cbs closure var = cbs.sem_var.sem_var closure (rreil-convert-sem-id cbs closure var.id) var.offset
...
val rreil-convert-branch-hint cbs closure hint = cbs.branch_hint.branch_hint closure (index hint)
