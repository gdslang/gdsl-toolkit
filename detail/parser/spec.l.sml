            ...
            if inp = 0wx3B
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      ...
                      then yyAction38(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
                else if inp = 0wx2F
                  then yyQ71(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx2F
                  ...
                  then yyAction47(strm, yyNO_MATCH)
                  else yyQ78(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp = 0wx61
              then yyQ78(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp < 0wx61
              then if inp = 0wx5F
...
fun yyQ93 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction15(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx41
              then yyQ78(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
            else if inp < 0wx41
              then if inp = 0wx2E
       ...
       of NONE => yyAction17(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx2F
                  then yyQ78(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
                      then yyQ78(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                  ...
                  then yyAction17(strm, yyNO_MATCH)
                  else yyQ78(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
            else if inp = 0wx61
              then yyQ78(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
            else if inp < 0wx61
              then if inp = 0wx5F
              ...
              then if inp = 0wx63
                  then yyQ102(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                  else yyQ78(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
            else if inp <= 0wx7A
              then yyQ78(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
              else yyAction17(strm, yyNO_MATCH)
        ...
        | SOME(inp, strm') =>
            if inp = 0wx60
              ...
              then if inp = 0wx6D
                  ...
                  else yyQ118(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp = 0wx79
              then yyQ78(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp < 0wx79
              then if inp = 0wx78
...
fun yyQ131 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction18(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx41
              then yyQ78(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp < 0wx41
              then if inp = 0wx2E
       ...
       of NONE => yyAction47(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx65
                  then yyQ138(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
                  else yyQ78(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp <= 0wx7A
              then yyQ78(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
              else yyAction47(strm, yyNO_MATCH)
       ...
       of NONE => yyAction47(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx79
                  then yyQ136(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
                  else yyQ78(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
              else yyAction47(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction47(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx74
                  then yyQ135(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
                  else yyQ78(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp <= 0wx7A
              then yyQ78(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
              else yyAction47(strm, yyNO_MATCH)
       ...
       of NONE => yyAction47(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then yyQ139(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
            else if inp < 0wx61
              then if inp = 0wx5F
                  then yyQ78(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
                  else yyAction47(strm, yyNO_MATCH)
            ...
            if inp = 0wx3B
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      ...
                      then yyAction19(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
                else if inp = 0wx2F
                  then yyQ71(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
       ...
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx2F
              ...
              then yyQ143(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
              else yyAction49(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ145 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction52(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx41
              then yyQ145(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
            else if inp < 0wx41
              then if inp = 0wx30
                  then yyQ145(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
                else if inp < 0wx30
        ...
        | SOME(inp, strm') =>
            if inp = 0wx3C
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx2E
                      then yyAction47(strm, yyNO_MATCH)
                      else yyQ146(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
                else if inp = 0wx3A
                  then yyQ71(strm', yyMATCH(strm, yyAction47, yyNO_MATCH))
                else if inp = 0wx3B
                  then yyAction47(strm, yyNO_MATCH)
            ...
            if inp = 0wx3B
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      ...
                      then yyAction37(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
                else if inp = 0wx2F
                  then yyQ71(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
       ...
       of NONE => yyAction56(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wxA
              ...
              else yyQ148(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
      (* end case *))
fun yyQ149 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction48(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx3A
              then yyQ149(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp < 0wx3A
              then if inp = 0wx27
                  then yyQ148(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                else if inp < 0wx27
                  then if inp = 0wx21
                      then yyQ149(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                    else if inp < 0wx21
                      then if inp = 0wxA
                          then yyAction48(strm, yyNO_MATCH)
                          else yyQ148(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                    else if inp = 0wx22
                      then yyQ148(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                      else yyQ149(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                else if inp = 0wx2D
                  then yyQ149(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                else if inp < 0wx2D
                  then if inp = 0wx2A
...
fun yyQ29 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx30
              then yyQ29(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp < 0wx30
