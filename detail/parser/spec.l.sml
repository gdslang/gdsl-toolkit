...
fun yyAction1 (strm, lastMatch : yymatch) = (yystrm := strm;  T.KW_export)
fun yyAction2 (strm, lastMatch : yymatch) = (yystrm := strm;  T.KW_type)
fun yyAction3 (strm, lastMatch : yymatch) = (yystrm := strm;  T.KW_raise)
fun yyAction4 (strm, lastMatch : yymatch) = (yystrm := strm;  T.KW_if)
fun yyAction5 (strm, lastMatch : yymatch) = (yystrm := strm;  T.KW_then)
fun yyAction6 (strm, lastMatch : yymatch) = (yystrm := strm;  T.KW_else)
fun yyAction7 (strm, lastMatch : yymatch) = (yystrm := strm;  T.KW_case)
fun yyAction8 (strm, lastMatch : yymatch) = (yystrm := strm;  T.KW_let)
fun yyAction9 (strm, lastMatch : yymatch) = (yystrm := strm;  T.KW_val)
fun yyAction10 (strm, lastMatch : yymatch) = (yystrm := strm;  T.KW_end)
fun yyAction11 (strm, lastMatch : yymatch) = (yystrm := strm;  T.KW_do)
fun yyAction12 (strm, lastMatch : yymatch) = (yystrm := strm;  T.KW_in)
fun yyAction13 (strm, lastMatch : yymatch) = (yystrm := strm;  T.KW_and)
fun yyAction14 (strm, lastMatch : yymatch) = (yystrm := strm;  T.KW_or)
fun yyAction15 (strm, lastMatch : yymatch) = (yystrm := strm;  T.MONAD)
fun yyAction16 (strm, lastMatch : yymatch) = (yystrm := strm;  T.SMALLER)
fun yyAction17 (strm, lastMatch : yymatch) = (yystrm := strm;  T.LARGER)
fun yyAction18 (strm, lastMatch : yymatch) = (yystrm := strm;  T.BIND)
fun yyAction19 (strm, lastMatch : yymatch) = (yystrm := strm;  T.TO)
fun yyAction20 (strm, lastMatch : yymatch) = (yystrm := strm;  T.DOUBLE_TO)
fun yyAction21 (strm, lastMatch : yymatch) = (yystrm := strm;  T.KW_mod)
fun yyAction22 (strm, lastMatch : yymatch) = (yystrm := strm;  T.KW_of)
fun yyAction23 (strm, lastMatch : yymatch) = (yystrm := strm;  T.LB)
fun yyAction24 (strm, lastMatch : yymatch) = (yystrm := strm;  T.RB)
fun yyAction25 (strm, lastMatch : yymatch) = (yystrm := strm;  T.LCB)
fun yyAction26 (strm, lastMatch : yymatch) = (yystrm := strm;  T.RCB)
fun yyAction27 (strm, lastMatch : yymatch) = (yystrm := strm;  T.WILD)
fun yyAction28 (strm, lastMatch : yymatch) = (yystrm := strm;  T.TIMES)
fun yyAction29 (strm, lastMatch : yymatch) = (yystrm := strm;  T.WITH)
fun yyAction30 (strm, lastMatch : yymatch) = (yystrm := strm;  T.SELECT)
...
fun yyAction34 (strm, lastMatch : yymatch) = (yystrm := strm;  T.CONCAT)
fun yyAction35 (strm, lastMatch : yymatch) = (yystrm := strm;  T.BAR)
fun yyAction36 (strm, lastMatch : yymatch) = (yystrm := strm;  T.COLON)
fun yyAction37 (strm, lastMatch : yymatch) = (yystrm := strm;  T.UNIT)
fun yyAction38 (strm, lastMatch : yymatch) = (yystrm := strm;  T.LP)
fun yyAction39 (strm, lastMatch : yymatch) = (yystrm := strm;  T.RP)
...
fun yyAction54 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;  T.MID (Atom.atom yytext)
      end
...
fun yyQ80 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction58(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx45
              then yyQ81(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
            else if inp < 0wx45
              then if inp = 0wx30
            ...
            if inp = 0wx3B
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      ...
                      then yyAction55(strm, yyNO_MATCH)
                      else yyQ77(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
                else if inp = 0wx2F
                  then yyQ77(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
            ...
            if inp = 0wx3B
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      ...
                      then yyAction42(strm, yyNO_MATCH)
                      else yyQ77(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
                else if inp = 0wx2F
                  then yyQ77(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
                  ...
                  then yyQ77(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
                  else yyQ78(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp = 0wx60
              then yyQ77(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp < 0wx60
              then if inp = 0wx5D
        ...
        | SOME(inp, strm') =>
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  else yyQ84(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction53(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
            ...
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  then if inp = 0wx22
                      ...
                      then if inp = 0wx21
                          then yyQ84(strm', yyMATCH(strm, yyAction9, yyNO_MATCH))
                  ...
                  else yyQ84(strm', yyMATCH(strm, yyAction9, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction9(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
        ...
        | SOME(inp, strm') =>
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  else yyQ84(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction5(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
        ...
        | SOME(inp, strm') =>
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  else yyQ84(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction3(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
        ...
        | SOME(inp, strm') =>
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  else yyQ84(strm', yyMATCH(strm, yyAction14, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction14(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
        ...
        | SOME(inp, strm') =>
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  else yyQ84(strm', yyMATCH(strm, yyAction8, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction8(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
            ...
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  then if inp = 0wx22
                      ...
                      then if inp = 0wx21
                          then yyQ84(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
                  ...
                  else yyQ84(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction12(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
        ...
        | SOME(inp, strm') =>
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  else yyQ84(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction4(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
        ...
        | SOME(inp, strm') =>
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  else yyQ84(strm', yyMATCH(strm, yyAction10, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction10(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
            ...
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  then if inp = 0wx22
                      ...
                      then if inp = 0wx21
                          then yyQ84(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
                  ...
                  else yyQ84(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction6(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
            ...
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  then if inp = 0wx22
                      ...
                      then if inp = 0wx21
                          then yyQ84(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
                  ...
                  else yyQ84(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction11(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
            ...
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  then if inp = 0wx22
                      ...
                      then if inp = 0wx21
                          then yyQ84(strm', yyMATCH(strm, yyAction7, yyNO_MATCH))
                  ...
                  else yyQ84(strm', yyMATCH(strm, yyAction7, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction7(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
       ...
       of NONE => yyAction53(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx3F
              ...
              then if inp = 0wx65
                  then yyQ126(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
                  else yyQ84(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
            else if inp <= 0wx7A
              then yyQ84(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
              else yyAction53(strm, yyNO_MATCH)
            ...
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  then if inp = 0wx22
                      ...
                      then if inp = 0wx21
                          then yyQ84(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
                  ...
                  else yyQ84(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction13(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
        ...
        | SOME(inp, strm') =>
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  else yyQ129(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction54(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
            ...
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  then if inp = 0wx22
                      ...
                      then if inp = 0wx21
                          then yyQ129(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
                  ...
                  else yyQ129(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction27(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
            ...
            if inp = 0wx3B
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      ...
                      then yyAction34(strm, yyNO_MATCH)
                      else yyQ77(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
                else if inp = 0wx2F
                  then yyQ77(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
            ...
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  then if inp = 0wx22
                      ...
                      then if inp = 0wx21
                          then yyQ130(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
                  ...
                  else yyQ130(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction52(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
            ...
            if inp = 0wx3A
              ...
              then if inp = 0wx28
                  ...
                  then if inp = 0wx22
                      ...
                      then if inp = 0wx21
                          then yyQ130(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
                  ...
                  else yyQ130(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
            else if inp = 0wx5B
              then yyAction15(strm, yyNO_MATCH)
            else if inp < 0wx5B
              then if inp = 0wx40
            ...
            if inp = 0wx3B
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      ...
                      then yyAction29(strm, yyNO_MATCH)
                      else yyQ77(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
                else if inp = 0wx2F
                  then yyQ77(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
        ...
        | SOME(inp, strm') =>
            if inp = 0wx3B
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      then yyQ77(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                    else if inp < 0wx23
                      then if inp = 0wx21
                          then yyQ77(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                      ...
                      then yyAction17(strm, yyNO_MATCH)
                      else yyQ77(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                else if inp = 0wx2F
                  then yyQ77(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
        ...
        | SOME(inp, strm') =>
            if inp = 0wx3B
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      then yyQ77(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
                    else if inp < 0wx23
                      then if inp = 0wx21
                          then yyQ77(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
                      ...
                      then yyAction20(strm, yyNO_MATCH)
                      else yyQ77(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
                else if inp = 0wx2F
                  then yyQ77(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
            ...
            if inp = 0wx3C
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      ...
                      then yyAction31(strm, yyNO_MATCH)
                      else yyQ77(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
                else if inp = 0wx30
                  then yyAction31(strm, yyNO_MATCH)
                else if inp < 0wx30
                  then if inp = 0wx2E
              ...
              then if inp = 0wx41
                  ...
                  then if inp = 0wx3E
                      then yyQ131(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
                      else yyQ77(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
                else if inp = 0wx5D
                  then yyAction31(strm, yyNO_MATCH)
                else if inp < 0wx5D
            ...
            if inp = 0wx3B
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      ...
                      then yyAction18(strm, yyNO_MATCH)
                      else yyQ77(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
                else if inp = 0wx2F
                  then yyQ77(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
            ...
            if inp = 0wx3B
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      ...
                      then yyAction16(strm, yyNO_MATCH)
                      else yyQ77(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                else if inp = 0wx2F
                  then yyQ77(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
                      then yyQ132(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                      else yyAction16(strm, yyNO_MATCH)
                else if inp = 0wx3A
                  then yyQ77(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                  else yyAction16(strm, yyNO_MATCH)
            ...
            if inp = 0wx3B
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      ...
                      then yyAction36(strm, yyNO_MATCH)
                      else yyQ77(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
                else if inp = 0wx2F
                  then yyQ77(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
       ...
       of NONE => yyAction56(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx2F
              ...
              then yyQ133(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
              else yyAction56(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ135 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx41
              then yyQ135(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp < 0wx41
              then if inp = 0wx30
                  then yyQ135(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
                else if inp < 0wx30
       ...
       of NONE => yyAction56(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx30
              ...
              then yyQ134(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp < 0wx78
              then if inp <= 0wx39
                  then yyQ133(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                  else yyAction56(strm, yyNO_MATCH)
...
fun yyQ136 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction53(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx3F
              then yyQ136(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
            else if inp < 0wx3F
              then if inp = 0wx2C
                  then yyAction53(strm, yyNO_MATCH)
                else if inp < 0wx2C
                  ...
                  then if inp = 0wx2E
                      then yyAction53(strm, yyNO_MATCH)
                      else yyQ136(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
                else if inp = 0wx3B
                  then yyAction53(strm, yyNO_MATCH)
                else if inp < 0wx3B
                  then if inp = 0wx3A
        ...
        | SOME(inp, strm') =>
            if inp = 0wx3B
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      then yyQ77(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
                    else if inp < 0wx23
                      then if inp = 0wx21
                          then yyQ77(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
                      ...
                      then yyAction19(strm, yyNO_MATCH)
                      else yyQ77(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
                else if inp = 0wx2F
                  then yyQ77(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
        ...
        | SOME(inp, strm') =>
            if inp = 0wx3C
              ...
              then if inp = 0wx41
                  ...
                  then if inp = 0wx3E
                      then yyQ137(strm', yyMATCH(strm, yyAction41, yyNO_MATCH))
                      else yyQ77(strm', yyMATCH(strm, yyAction41, yyNO_MATCH))
                else if inp = 0wx5D
                  then yyAction41(strm, yyNO_MATCH)
                else if inp < 0wx5D
            ...
            if inp = 0wx3B
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      ...
                      then yyAction28(strm, yyNO_MATCH)
                      else yyQ77(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
                else if inp = 0wx2F
                  then yyQ77(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
...
fun yyQ39 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction38(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx2A
              then yyQ139(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
            else if inp < 0wx2A
              then if inp = 0wx29
                  then yyQ138(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
            ...
            if inp = 0wx3B
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      ...
                      then yyAction21(strm, yyNO_MATCH)
                      else yyQ77(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
                else if inp = 0wx2F
                  then yyQ77(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
            ...
            if inp = 0wx3B
              ...
              then if inp = 0wx2C
                  ...
                  then if inp = 0wx23
                      ...
                      then yyAction30(strm, yyNO_MATCH)
                      else yyQ77(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
                else if inp = 0wx2F
                  then yyQ77(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
                else if inp < 0wx2F
                  then if inp = 0wx2D
...
fun yyQ142 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx3A
              then yyQ142(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
            else if inp < 0wx3A
              then if inp = 0wx27
                  then yyQ140(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
                else if inp < 0wx27
                  then if inp = 0wx21
                      then yyQ142(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
                    else if inp < 0wx21
                      then if inp = 0wxA
                          then yyQ141(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
                          else yyQ140(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
                    else if inp = 0wx22
                      then yyQ140(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
                      else yyQ142(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
                else if inp = 0wx2D
                  then yyQ142(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
                else if inp < 0wx2D
                  then if inp = 0wx2A
...
fun yyQ31 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction48(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx30
              then yyQ31(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp < 0wx30
              then if inp = 0wx2E
                  then yyQ31(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
...
fun yyQ24 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction56(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx30
              then yyQ24(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp < 0wx30
              then yyAction56(strm, yyNO_MATCH)
            else if inp <= 0wx39
              then yyQ24(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
...
fun yyQ17 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction71(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx29
              then yyQ18(strm', yyMATCH(strm, yyAction71, yyNO_MATCH))
...
fun yyQ16 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction71(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx2A
              then yyQ19(strm', yyMATCH(strm, yyAction71, yyNO_MATCH))
              else yyAction71(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ8 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction68(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx66
              then yyQ10(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
            else if inp < 0wx66
              then if inp = 0wx3A
                  then yyQ9(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
                else if inp < 0wx3A
                  then if inp = 0wx23
                      then yyQ9(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
                    else if inp < 0wx23
                      then if inp = 0wx22
                          then yyQ10(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
                          else yyQ9(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
                    else if inp <= 0wx2F
                      then yyQ9(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
                      else yyQ11(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
                else if inp = 0wx5D
                  then yyQ9(strm', yyMATCH(strm, yyAction68, yyNO_MATCH))
                else if inp < 0wx5D
                  then if inp = 0wx5C
        ...
        | SOME(inp, strm') =>
            if inp = 0wx23
              ...
              then if inp = 0wx20
                  ...
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ14(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp = 0wx5D
              then yyQ14(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < 0wx5D
              then if inp = 0wx5C
