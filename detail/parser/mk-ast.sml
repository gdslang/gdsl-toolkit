   ...
   structure PP = struct
      ...
      and decodepat t =
         case t of
            ...
            (*MARKdecodepat {span=s, tree=t'} => seq [str (Error.spanToString s), decodepat t']*)
      ...
      and bitpat t =
         case t of
            ...
            (*MARKbitpat {span=s, tree=t'} => seq [str (Error.spanToString s), bitpat t']*)
      ...
      and tokpat t =
         case t of
            ...
            (*MARKtokpat {span=s, tree=t'} => seq [str (Error.spanToString s), tokpat t']*)
          | TOKtokpat (size,tok) =>
