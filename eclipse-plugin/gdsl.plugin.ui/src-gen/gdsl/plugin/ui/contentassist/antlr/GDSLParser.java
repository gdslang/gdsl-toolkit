		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDeclTypeAccess().getGroup_2_1_5(), "rule__DeclType__Group_2_1_5__0");
					put(grammarAccess.getDeclTypeAccess().getGroup_2_1_5_1(), "rule__DeclType__Group_2_1_5_1__0");
					...
					put(grammarAccess.getDeclTypeAccess().getAttrAssignment_2_1_1(), "rule__DeclType__AttrAssignment_2_1_1");
					put(grammarAccess.getDeclTypeAccess().getAttrAssignment_2_1_2_1(), "rule__DeclType__AttrAssignment_2_1_2_1");
					put(grammarAccess.getDeclTypeAccess().getConDeclAssignment_2_1_5_0(), "rule__DeclType__ConDeclAssignment_2_1_5_0");
					put(grammarAccess.getDeclTypeAccess().getConDeclAssignment_2_1_5_1_1(), "rule__DeclType__ConDeclAssignment_2_1_5_1_1");
					...
					put(grammarAccess.getExportAccess().getAttrAssignment_1_1(), "rule__Export__AttrAssignment_1_1");
					put(grammarAccess.getExportAccess().getAttrAssignment_1_2_1(), "rule__Export__AttrAssignment_1_2_1");
					...
					put(grammarAccess.getTyAccess().getDeclAssignment_2_0_0(), "rule__Ty__DeclAssignment_2_0_0");
					...
					put(grammarAccess.getValueDeclAccess().getNameAssignment_1(), "rule__ValueDecl__NameAssignment_1");
