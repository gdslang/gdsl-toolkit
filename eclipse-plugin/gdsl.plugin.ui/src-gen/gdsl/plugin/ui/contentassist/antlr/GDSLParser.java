		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDeclTypeAccess().getAlternatives_4(), "rule__DeclType__Alternatives_4");
					...
					put(grammarAccess.getTyAccess().getValueAlternatives_0_0(), "rule__Ty__ValueAlternatives_0_0");
					put(grammarAccess.getTyAccess().getAlternatives_3_0(), "rule__Ty__Alternatives_3_0");
					put(grammarAccess.getTyAccess().getTypeAlternatives_3_0_1_0(), "rule__Ty__TypeAlternatives_3_0_1_0");
					...
					put(grammarAccess.getArgsAccess().getAlternatives_1(), "rule__Args__Alternatives_1");
					...
					put(grammarAccess.getDeclTypeAccess().getGroup_4_0(), "rule__DeclType__Group_4_0__0");
					put(grammarAccess.getDeclTypeAccess().getGroup_4_0_0(), "rule__DeclType__Group_4_0_0__0");
					put(grammarAccess.getDeclTypeAccess().getGroup_4_0_0_1(), "rule__DeclType__Group_4_0_0_1__0");
					...
					put(grammarAccess.getTyAccess().getGroup_3_1(), "rule__Ty__Group_3_1__0");
					put(grammarAccess.getTyAccess().getGroup_3_1_2(), "rule__Ty__Group_3_1_2__0");
					...
					put(grammarAccess.getTyAccess().getGroup_4_2_1(), "rule__Ty__Group_4_2_1__0");
					put(grammarAccess.getTyAccess().getGroup_5(), "rule__Ty__Group_5__0");
					put(grammarAccess.getTyAccess().getGroup_5_2(), "rule__Ty__Group_5_2__0");
					put(grammarAccess.getTyAccess().getGroup_6(), "rule__Ty__Group_6__0");
					put(grammarAccess.getTyAccess().getGroup_6_2(), "rule__Ty__Group_6_2__0");
					put(grammarAccess.getTyAccess().getGroup_7(), "rule__Ty__Group_7__0");
					...
					put(grammarAccess.getDeclTypeAccess().getTyVarsAssignment_2(), "rule__DeclType__TyVarsAssignment_2");
					put(grammarAccess.getDeclTypeAccess().getConDeclAssignment_4_0_0_0(), "rule__DeclType__ConDeclAssignment_4_0_0_0");
					put(grammarAccess.getDeclTypeAccess().getConDeclAssignment_4_0_0_1_1(), "rule__DeclType__ConDeclAssignment_4_0_0_1_1");
					put(grammarAccess.getDeclTypeAccess().getValueAssignment_4_1(), "rule__DeclType__ValueAssignment_4_1");
					...
					put(grammarAccess.getTyAccess().getTypeRefAssignment_2_1(), "rule__Ty__TypeRefAssignment_2_1");
					put(grammarAccess.getTyAccess().getTypeRefAssignment_3_0_0(), "rule__Ty__TypeRefAssignment_3_0_0");
					put(grammarAccess.getTyAccess().getTypeAssignment_3_0_1(), "rule__Ty__TypeAssignment_3_0_1");
					put(grammarAccess.getTyAccess().getTyBindAssignment_3_1_1(), "rule__Ty__TyBindAssignment_3_1_1");
					put(grammarAccess.getTyAccess().getTyBindAssignment_3_1_2_1(), "rule__Ty__TyBindAssignment_3_1_2_1");
					put(grammarAccess.getTyAccess().getElementsAssignment_4_2_0(), "rule__Ty__ElementsAssignment_4_2_0");
					put(grammarAccess.getTyAccess().getElementsAssignment_4_2_1_1(), "rule__Ty__ElementsAssignment_4_2_1_1");
					put(grammarAccess.getTyAccess().getParamAssignment_5_1(), "rule__Ty__ParamAssignment_5_1");
					put(grammarAccess.getTyAccess().getParamAssignment_5_2_1(), "rule__Ty__ParamAssignment_5_2_1");
					put(grammarAccess.getTyAccess().getResTypeAssignment_5_5(), "rule__Ty__ResTypeAssignment_5_5");
					put(grammarAccess.getTyAccess().getResTypeAssignment_6_2_1(), "rule__Ty__ResTypeAssignment_6_2_1");
					put(grammarAccess.getTyAccess().getRAssignment_7_1(), "rule__Ty__RAssignment_7_1");
					put(grammarAccess.getTyAccess().getInAssignment_7_3(), "rule__Ty__InAssignment_7_3");
					put(grammarAccess.getTyAccess().getOutAssignment_7_5(), "rule__Ty__OutAssignment_7_5");
					...
					put(grammarAccess.getApplyExpAccess().getArgsAssignment_1_1(), "rule__ApplyExp__ArgsAssignment_1_1");
					put(grammarAccess.getArgsAccess().getArgsAssignment_1_0(), "rule__Args__ArgsAssignment_1_0");
