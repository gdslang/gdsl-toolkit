/*
 * This code is partly generated and represents the interface that
 * the different instructions decoders, etc. expose.
 */
...
enum id_shared { ID_FLOATING_FLAGS = 0 };
...
enum exception { EXCEPTION_DIVISION_BY_ZERO = 0 };

enum flop { FLOP_FADD = 0, FLOP_FSUB = 1, FLOP_FMUL = 2 };
...
typedef unboxed_asm_annotation_list_callbacks_t*
    asm_annotation_list_callbacks_t;
typedef struct {
