...
extern int_t decoder_config_from_args(char *success, state_t s, struct config_handlers handlers, int argc, char **argv);
extern void decoder_config_print_options(state_t s, struct config_handlers handlers);
