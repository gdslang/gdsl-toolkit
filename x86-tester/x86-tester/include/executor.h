...
enum execution_result_type {
	EXECUTION_RTYPE_SUCCESS,
	EXECUTION_RTYPE_MAPPING_ERROR,
	EXECUTION_RTYPE_SIGNAL
};
...
extern struct execution_result executor_instruction_execute(uint8_t *instruction, size_t instruction_length,
