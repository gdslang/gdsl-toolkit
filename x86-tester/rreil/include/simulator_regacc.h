...
extern void simulator_register_read(struct simulator_context *context,
		struct rreil_id *id, uint8_t *buffer, size_t bit_length, size_t bit_offset);
extern void simulator_register_read_8(struct simulator_context *context,
		struct rreil_id *id, uint8_t *buffer, size_t bit_offset);
extern void simulator_register_read_16(struct simulator_context *context,
		struct rreil_id *id, uint8_t *buffer, size_t bit_offset);
extern void simulator_register_read_32(struct simulator_context *context,
		struct rreil_id *id, uint8_t *buffer, size_t bit_offset);
...
extern void simulator_register_write_16(struct simulator_context *context,
		struct rreil_id *id, uint16_t data, size_t bit_offset);
extern void simulator_register_write_32(struct simulator_context *context,
		struct rreil_id *id, uint32_t data, size_t bit_offset);
extern void simulator_register_write_64(struct simulator_context *context,
